...
monthly_ret_df = pflio(return_df,6,3)    
print("Portfolio CAGR",CAGR(monthly_ret_df))
print("Portfolio Sharpe",sharpe(monthly_ret_df,0.025))
print("Portfolio MaxDD",max_dd(monthly_ret_df)) 
...
print("Dow Jones CAGR",CAGR(DJI))
print("Dow Jones Sharpe",sharpe(DJI,0.025))
print("Dow Jones MaxDD",max_dd(DJI))

#visualization
fig, ax = plt.subplots()
plt.plot((1+monthly_ret_df).cumprod())
